...
export const ToS = () => {
  return (
      <div class="paragraph">
        <p>TEAM SOLUTIONS TERMS OF SERVICE</p>
<p>Last Updated: 11/2020</p>

<p>These terms of service ("Terms") apply to your access and use of HONEST WORK (the "Service"). Please read them carefully.
</p>
...
<p>Privacy Policy
For information about how we collect and use information about users of the Service, please check out our privacy policy available at [INSERT LINK].</p>
...
<p>[INCLUDE ANY OTHER CONTENT RESTRICTIONS THAT MAY BE UNIQUE TO YOUR COMPANY.]
</p>

<p>Content that is libelous, defamatory, bigoted, fraudulent or deceptive;
...
<p>TEAM SOLUTIONS makes no claim or representation regarding, and accepts no responsibility for third party websites accessible by hyperlink from the Service or websites linking to the Service. When you leave the Service, you should be aware that these Terms and our policies no longer govern.
